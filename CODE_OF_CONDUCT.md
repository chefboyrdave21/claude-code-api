...
to the maintainer through the
[GitHub profile for `chefboyrdave21`](https://github.com/chefboyrdave21), or, for a
report that should stay private, through
[private vulnerability reporting](https://github.com/chefboyrdave21/claude-code-api/security)
on this repository.

This is a single-maintainer project. Reports go to one person, who is also the person
you may be reporting about. If that is a conflict for you, GitHub's own
[abuse reporting](https://github.com/contact/report-abuse) is an independent channel
and using it is entirely appropriate.
...
with the community for a specified period of time. Violating these terms may lead to
a permanent ban.
